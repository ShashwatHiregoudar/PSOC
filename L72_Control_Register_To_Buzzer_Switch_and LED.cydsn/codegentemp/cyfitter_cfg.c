...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT13), 0x00000010u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT15), 0x00000020u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x80002EDFu);

	/* CYDEV_CLK_DIVIDER_B00 Starting address: CYDEV_CLK_DIVIDER_B00 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B00), 0x80005DBFu);
