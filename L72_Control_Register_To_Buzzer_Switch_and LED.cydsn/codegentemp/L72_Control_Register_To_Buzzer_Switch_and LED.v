// ======================================================================
// L72_Control_Register_To_Buzzer_Switch_and LED.v generated from TopDesign.cysch
// 01/31/2019 at 10:54
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_23 or Net_38 or Net_53)
        begin
            case (Net_53)
                1'b0 :  tmp__mux_1_reg = Net_23;
                1'b1 :  tmp__mux_1_reg = Net_38;
            endcase
        end
        assign Net_43 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_30)
    begin
        cy_tff_1 <= Net_32^Net_38;
    end
    assign Net_38 = cy_tff_1;
    // -- TFF End --

    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_26)
    begin
        cy_tff_2 <= Net_35^Net_23;
    end
    assign Net_23 = cy_tff_2;
    // -- TFF End --
	...
	cy_psoc3_pins_v1_10
		#(.id("25f9c005-bb19-4b3e-9f86-a4f8eba33f29"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aab2341c-6c7a-4bc9-8cbd-30dee020e483"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    begin : demux_1
        ...
        always @(Net_22 or Net_53)
        begin
            case (Net_53)
                1'b0:
                begin
                    tmp__demux_1_0_reg = Net_22;
                    tmp__demux_1_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_1_0_reg = 1'b0;
                    tmp__demux_1_1_reg = Net_22;
                end
            endcase
        end
        assign Net_51 = tmp__demux_1_0_reg;
        assign Net_41 = tmp__demux_1_1_reg;
    end
    // -- De Mux end --
