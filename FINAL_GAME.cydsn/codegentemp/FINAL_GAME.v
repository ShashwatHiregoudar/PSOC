// ======================================================================
// FINAL_GAME.v generated from TopDesign.cysch
// 02/15/2019 at 18:40
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ecf16f11-9c10-4992-b75e-d6275d9149b6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_SEQ_P4_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("127e670b-4112-46d2-9199-8b6b5a7a0d62/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d46ced9c-6c98-4186-bf26-4014a37ccf7e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Button4_net;
	wire [0:0] tmpIO_0__Button4_net;
	wire [0:0] tmpINTERRUPT_0__Button4_net;
	electrical [0:0] tmpSIOVREF__Button4_net;

	cy_psoc3_pins_v1_10
		#(.id("e87e4a09-acb4-4d02-92c5-1277545490d1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button4
		 (.oe(tmpOE__Button4_net),
		  .y({1'b0}),
		  .fb({Net_104}),
		  .io({tmpIO_0__Button4_net[0:0]}),
		  .siovref(tmpSIOVREF__Button4_net),
		  .interrupt({tmpINTERRUPT_0__Button4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Button3_net;
	wire [0:0] tmpIO_0__Button3_net;
	wire [0:0] tmpINTERRUPT_0__Button3_net;
	electrical [0:0] tmpSIOVREF__Button3_net;

	cy_psoc3_pins_v1_10
		#(.id("6507fd44-cab1-46e4-943e-aef960cb02fe"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button3
		 (.oe(tmpOE__Button3_net),
		  .y({1'b0}),
		  .fb({Net_105}),
		  .io({tmpIO_0__Button3_net[0:0]}),
		  .siovref(tmpSIOVREF__Button3_net),
		  .interrupt({tmpINTERRUPT_0__Button3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_CHEAT_net;
	wire [0:0] tmpIO_0__Button_CHEAT_net;
	wire [0:0] tmpINTERRUPT_0__Button_CHEAT_net;
	electrical [0:0] tmpSIOVREF__Button_CHEAT_net;

	cy_psoc3_pins_v1_10
		#(.id("6e5bd0e9-0eb3-488e-b235-e42af0e2c309"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button_CHEAT
		 (.oe(tmpOE__Button_CHEAT_net),
		  .y({1'b0}),
		  .fb({Net_78}),
		  .io({tmpIO_0__Button_CHEAT_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_CHEAT_net),
		  .interrupt({tmpINTERRUPT_0__Button_CHEAT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_CHEAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ec8c8a33-acfc-46a7-99a7-50cecda49bfb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("54bb9f84-4192-447b-8c8d-d60f4f101645"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0e7fb8e8-57c5-4589-86c3-9cb83427de47"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_94 = ~Net_107;


    assign Net_154 = ~Net_104;


    assign Net_150 = ~Net_106;


    assign Net_151 = ~Net_105;

    CyStatusReg_v1_90 Status_Register (
        .status_0(Net_94),
        .status_1(Net_150),
        .status_2(Net_151),
        .status_3(Net_154),
        ...
        .intr(Net_148),
        .status_bus(8'b0));
    defparam Status_Register.Bit0Mode = 0;
    defparam Status_Register.Bit1Mode = 0;
    defparam Status_Register.Bit2Mode = 0;
    defparam Status_Register.Bit3Mode = 0;
    defparam Status_Register.Bit4Mode = 0;
    defparam Status_Register.Bit5Mode = 0;
    defparam Status_Register.Bit6Mode = 0;
    defparam Status_Register.Bit7Mode = 0;
    defparam Status_Register.BusDisplay = 0;
    defparam Status_Register.Interrupt = 0;
    defparam Status_Register.MaskValue = 0;
    defparam Status_Register.NumInputs = 4;

    assign Net_143 = 1'h1;

	wire [0:0] tmpOE__Pin_in_buzzer_net;
	wire [0:0] tmpIO_0__Pin_in_buzzer_net;
	wire [0:0] tmpINTERRUPT_0__Pin_in_buzzer_net;
	electrical [0:0] tmpSIOVREF__Pin_in_buzzer_net;

	cy_psoc3_pins_v1_10
		#(.id("3bb6b506-dc3d-4123-b4fe-936994b73587"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_in_buzzer
		 (.oe(tmpOE__Pin_in_buzzer_net),
		  .y({1'b0}),
		  .fb({Net_268}),
		  .io({tmpIO_0__Pin_in_buzzer_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_in_buzzer_net),
		  .interrupt({tmpINTERRUPT_0__Pin_in_buzzer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_in_buzzer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("a9063f61-17fd-47fd-8737-2da4bc4a83f0"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_20)
    begin
        cy_tff_1 <= Net_268^Net_21;
    end
    assign Net_21 = cy_tff_1;
    // -- TFF End --

	wire [0:0] tmpOE__Pin_buzzer_net;
	wire [0:0] tmpFB_0__Pin_buzzer_net;
	wire [0:0] tmpIO_0__Pin_buzzer_net;
	wire [0:0] tmpINTERRUPT_0__Pin_buzzer_net;
	electrical [0:0] tmpSIOVREF__Pin_buzzer_net;

	cy_psoc3_pins_v1_10
		#(.id("fd6dc240-22c0-4ed6-8365-08aa11408217"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_buzzer
		 (.oe(tmpOE__Pin_buzzer_net),
		  .y({Net_21}),
		  .fb({tmpFB_0__Pin_buzzer_net[0:0]}),
		  .io({tmpIO_0__Pin_buzzer_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_buzzer_net),
		  .interrupt({tmpINTERRUPT_0__Pin_buzzer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_buzzer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
