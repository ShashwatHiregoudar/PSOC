// ======================================================================
// L4_Blink_with_button.v generated from TopDesign.cysch
// 01/29/2019 at 17:01
...
module top ;
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_7)
    begin
        cy_tff_1 <= Net_6^Net_8;
    end
    assign Net_8 = cy_tff_1;
    // -- TFF End --


	cy_clock_v1_0
		#(.id("251b349c-78bd-4935-9237-ee1f215308f5"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1E+15"),
		  .is_direct(0),
