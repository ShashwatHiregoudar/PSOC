// ======================================================================
// Blink_with_button_interrupt.v generated from TopDesign.cysch
// 01/18/2019 at 09:52
...
module top ;
	...
	wire [0:0] tmpOE__Pin_in_net;
	wire [0:0] tmpFB_0__Pin_in_net;
	wire [0:0] tmpIO_0__Pin_in_net;
	electrical [0:0] tmpSIOVREF__Pin_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_in
		 (.oe(tmpOE__Pin_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_in_net[0:0]}),
		  .io({tmpIO_0__Pin_in_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_in_net),
		  .interrupt({Net_6}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
