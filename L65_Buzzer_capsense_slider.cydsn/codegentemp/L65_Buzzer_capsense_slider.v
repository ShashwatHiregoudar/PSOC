// ======================================================================
// L65_Buzzer_capsense_slider.v generated from TopDesign.cysch
// 01/30/2019 at 15:30
...
module CapSense_CSD_P4_v2_60_2 ;
    ...
    defparam CSD_FFB.sensors_count = 10;
	...
	cy_psoc3_pins_v1_10
		#(.id("45ab877e-b47d-4a90-8b5e-7f91932dbdbe/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("45ab877e-b47d-4a90-8b5e-7f91932dbdbe/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  .drive_mode(30'b000_000_000_000_000_000_000_000_000_000),
		  .ibuf_enabled(10'b0_0_0_0_0_0_0_0_0_0),
		  .init_dr_st(10'b1_1_1_1_1_1_1_1_1_1),
		  .input_clk_en(0),
		  ...
		  .por_state(4),
		  .sio_group_cnt(0),
		  .sio_hyst(10'b1_1_1_1_1_1_1_1_1_1),
		  .sio_ibuf(""),
		  ...
		  .spanning(1),
		  .use_annotation(10'b0_0_0_0_0_0_0_0_0_0),
		  .vtrip(20'b10_10_10_10_10_10_10_10_10_10),
		  .width(10),
		  .ovt_hyst_trim(10'b0_0_0_0_0_0_0_0_0_0),
		  .ovt_needed(10'b0_0_0_0_0_0_0_0_0_0),
		  .ovt_slew_control(20'b00_00_00_00_00_00_00_00_00_00),
		  .input_buffer_sel(20'b00_00_00_00_00_00_00_00_00_00))
		Sns
		 (.oe(tmpOE__Sns_net),
		  .y({10'b0}),
	...
	assign tmpOE__Sns_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{10'b1111111111} : {10'b1111111111};
